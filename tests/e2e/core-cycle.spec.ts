...
test.describe.serial("@smoke core cycle", () => {
  ...
  test.describe.serial("as lead auditor", () => {
    ...
    // (9/23 on 1a95725; 23/23 on 08cb9c2 of this same branch). Skip the
    // rest of this serial chain too — exit meeting and freeze both need
    // `seededEngagementUrl` and a fully scored module.
